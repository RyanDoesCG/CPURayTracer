...
inline vec3 operator * (const vec3& lhs, const vec3& rhs)
    { return { lhs[0] * rhs[0], lhs[1] * rhs[1], lhs[2] * rhs[2] }; }
inline vec3 operator * (const vec3& lhs, real rhs)
    { return { lhs[0] * rhs, lhs[1] * rhs, lhs[2] * rhs }; }
inline vec3 operator * (real lhs, const vec3& rhs)
    { return { lhs * rhs[0], lhs * rhs[1], lhs * rhs[2] }; }
inline vec2 operator * (const vec2& lhs, const vec2& rhs)
    { return { lhs[0] * rhs[0], lhs[1] * rhs[1] }; }
inline vec2 operator * (real lhs, const vec2& rhs)
    { return { lhs * rhs[0], lhs * rhs[1] }; }
inline vec2 operator * (const vec2& lhs, real rhs)
...
inline vec3 operator / (real lhs, const vec3& rhs)
    { return { lhs / rhs[0], lhs / rhs[1], lhs / rhs[2] }; }
/** dot products */
inline real dot (const vec4& lhs, const vec4& rhs)
    { return lhs[0] * rhs[0] + lhs[1] * rhs[1] + lhs[2] * rhs[2] + lhs[3] * rhs[3]; }
inline real dot (const vec3& lhs, const vec3& rhs)
    { return lhs[0] * rhs[0] + lhs[1] * rhs[1] + lhs[2] * rhs[2]; }
inline real dot (const vec2& lhs, const vec2& rhs)
    { return lhs[0] * rhs[0] + lhs[1] * rhs[1]; }
/** cross product */
